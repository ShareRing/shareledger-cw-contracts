...
use cw721_autoincrement_id::Cw721Contract;
pub use cw721_autoincrement_id::{ContractError, InstantiateMsg, MintMsg, MinterResponse};

use crate::msg::Cw2981QueryMsg;

// Version info for migration
const CONTRACT_NAME: &str = "crates.io:cw2981-royalties-autoincrement";
...
pub type ExecuteMsg = cw721_autoincrement_id::ExecuteMsg<Extension, Empty>;
pub type QueryMsg = cw721_autoincrement_id::QueryMsg<Cw2981QueryMsg>;
