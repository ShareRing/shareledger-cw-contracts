...
const CONTRACT_NAME: &str = "crates.io:cw721-autoincrement-id";
    ...
    Q: CustomMsg,
{
    pub fn mint(
        ...
        let id = self.increment_tokens(deps.storage)?.to_string();

        self.tokens.update(deps.storage, &id, |old| match old {
