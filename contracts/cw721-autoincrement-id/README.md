...
cp ../../target/wasm32-unknown-unknown/release/cw721_autoincrement_id.wasm .
ls -l cw721_autoincrement_id.wasm
sha256sum cw721_autoincrement_id.wasm
```
